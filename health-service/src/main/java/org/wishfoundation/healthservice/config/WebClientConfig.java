...
import org.wishfoundation.healthservice.exception.WebClientCustomException;
...
public class WebClientConfig {
    ...
    // Define the strategies for handling HTTP requests and responses.
    ...
    // Define the connection provider for managing HTTP client connections.
    ...
    // Filter function to handle HTTP response errors.
    ...
    // Helper function to parse HTTP headers into a map.
    ...
    // Bean method to create a WebClient builder with the defined settings.
    @Bean
