...
public class CustomUserDetailsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    private static Logger log = LoggerFactory.getLogger(CustomUserDetailsAuthenticationProvider.class);
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        if (authentication.getPrincipal() == null) {
            ...
            throw new BadCredentialsException(
                    messages.getMessage("AbstractUserDetailsAuthenticationProvider.badCredentials", "Bad  Email "));
        }
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        ...
        try {
            ...
            map.put(JWTService.USER_ROLE, new ArrayList<>(Arrays.asList("END_USER", "PARA","DOC")));
