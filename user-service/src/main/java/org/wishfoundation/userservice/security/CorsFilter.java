...
public class CorsFilter extends GenericFilterBean {
	...
	private static final List<String> ALLOWED_IPS = Arrays.asList("http://172.16.5.50", "http://172.16.5.53","http://localhost","http://172.16.5.50:*", "http://172.16.5.53:*","http://localhost:*","https://117.250.220.22:*","https://eswasthyadham.uk.gov.in:*","https://4.213.6.195:*","http://74.225.175.10:*","http://4.213.117.239:*");
